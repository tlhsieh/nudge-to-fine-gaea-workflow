...
SCRATCH_ROOT=/gpfs/f5/gfdl_w/scratch/$(USER)/$(EXPERIMENT_NAME)# Gaea
# SCRATCH_ROOT=/scratch/cimes/$(USER)/$(EXPERIMENT_NAME)# Stellar
...
RAW_VERIFICATION_ROOT=/gpfs/f5/gfdl_w/scratch/Tsung-Lin.Hsieh/2023-09-18-PIRE-X-SHiELD-post-processing/processed/control/coarsened_by_1x/diagnostics# Gaea
...
# RAW_VERIFICATION_ROOT=/scratch/cimes/skclark/2023-09-18-PIRE-X-SHiELD-post-processing/processed/control/diagnostics# Stellar
...
RESTARTS_ROOT=/gpfs/f5/gfdl_w/scratch/Tsung-Lin.Hsieh/2023-09-18-PIRE-X-SHiELD-post-processing/processed/control/coarsened_by_1x/restarts# Gaea
...
# RESTARTS_ROOT=/scratch/cimes/skclark/2023-09-18-PIRE-X-SHiELD-post-processing/processed/control/restarts# Stellar
